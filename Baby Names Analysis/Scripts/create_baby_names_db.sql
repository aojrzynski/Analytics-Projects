...
-- Do to the size, it is ideal to load the data manually via command prompt/terminal. Follow the instructions below.
--
...
> SET GLOBAL local_infile=true;alter

If you get the following error:
ERROR 2068 (HY000): LOAD DATA LOCAL INFILE file request rejected due to restrictions on access.

Redo the process, but this time star with 
